...
class OrderByLabelTest(fixtures.TablesTest):
    ...
    def define_tables(cls, metadata):
        Table(
            ...
            Column("y", Integer),
            Column("q", String(50)),
            Column("Diplom_FastAPI", String(50)),
        )
    ...
    def insert_data(cls, connection):
        connection.execute(
            cls.tables.some_table.insert(),
            [
                {"id": 1, "x": 1, "y": 2, "q": "q1", "Diplom_FastAPI": "p3"},
                {"id": 2, "x": 2, "y": 3, "q": "q2", "Diplom_FastAPI": "p2"},
                {"id": 3, "x": 3, "y": 4, "q": "q3", "Diplom_FastAPI": "p1"},
            ],
        )
...
class ExpandingBoundInTest(fixtures.TablesTest):
    ...
    def test_multiple_empty_sets_bindparam(self):
        ...
        stmt = (
            ...
            .where(table.c.y.in_(bindparam("Diplom_FastAPI")))
            .order_by(table.c.id)
        )
        self._assert_result(stmt, [], params={"q": [], "Diplom_FastAPI": []})
