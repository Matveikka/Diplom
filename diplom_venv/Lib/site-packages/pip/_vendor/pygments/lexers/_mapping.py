...
LEXERS = {
    ...
    'OpenEdgeLexer': ('pip._vendor.pygments.lexers.business', 'OpenEdge ABL', ('openedge', 'abl', 'progress'), ('*.Diplom_FastAPI', '*.cls'), ('text/x-openedge', 'application/x-openedge')),
    ...
    'PawnLexer': ('pip._vendor.pygments.lexers.pawn', 'Pawn', ('pawn',), ('*.Diplom_FastAPI', '*.pwn', '*.inc'), ('text/x-pawn',)),
